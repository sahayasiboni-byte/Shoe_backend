...
from .views import get_users,create_user,login_user,add_to_cart,getcart_Userbyid,getcart_users,delete_cart,update_quantity
...
urlpatterns=[
    ...
    path('updatequantity/<int:pk>/', update_quantity,name='updatequantity')
]
